  ...
  return (
    <aside id="sidebar" className="sidebar">
      <UnorderedList className="sidebar-nav" id="sidebar-nav">
        ...
        <ListItem {...SideBarDashboard}></ListItem>
        ...
        <li className="nav-item">
          <a className="nav-link collapsed btn disabled" href="users-profile.html">
        ...
        <li className="nav-item">
          <a className="nav-link collapsed btn disabled" href="pages-faq.html">
        ...
        <li className="nav-item">
          <a className="nav-link collapsed btn disabled" href="pages-contact.html">
        ...
        <li className="nav-item">
          <a className="nav-link collapsed btn disabled" href="pages-register.html">
        ...
        <li className="nav-item">
          <a className="nav-link collapsed btn disabled" href="pages-login.html">
        ...
        <li className="nav-item">
          <a className="nav-link collapsed btn disabled" href="pages-error-404.html">
        ...
        <li className="nav-item">
          <a className="nav-link collapsed btn disabled" href="pages-blank.html">
